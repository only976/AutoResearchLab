"""
Database Module
File-based storage under backend/db/maars/{plan_id}/: plan.json, execution.json, {task_id}/output.json.
Unified storage in backend/db.
...
# backend/maars/db/__init__.py -> parent.parent.parent = backend/
_BACKEND_ROOT = Path(__file__).resolve().parent.parent.parent
DB_DIR = _BACKEND_ROOT / "db" / "maars"
